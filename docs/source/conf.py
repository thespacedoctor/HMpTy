...
sys.path.insert(0, os.path.abspath('../../HMpTy/HMpTy'))
...
html_theme_options = {
    ...
    'github_repo': 'HMpTy',
    'strap_line': "Generate Hierarchical Triangular Mesh (HTM) IDs, crossmatch sets of sky-coordinates and more"
}
...
""" % locals()
link_resolver_url = "https://github.com/thespacedoctor/HMpTy/tree/master"
