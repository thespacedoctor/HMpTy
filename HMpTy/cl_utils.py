...
Usage:
    hmpty index -r <tableName> <primaryIdCol> <raCol> <decCol> (-s <pathToSettingsFile>|--host <host> --user <user> --passwd <passwd> --dbName <dbName>)
...
Options:
    ...
    -r, --reindex                                                   trigger a reindex of the entire table (regenerate all HTMIDs)
